...
function Footer() {
    return (
        <div className="bg-[rgba(57,57,61,1)]">
            <div className="px-4 sm:px-8 lg:px-25 py-8 sm:py-12 lg:py-15 flex flex-col gap-10">
                <div className="max-w-full lg:max-w-[70%]">
                    <span className="font-montserrat text-[24px] font-semibold leading-8 text-[rgba(254,254,255,1)]">Top 10 Trending Locations and Sales History - Last 30 Days</span>
                </div>
                <FooterBoxes />
