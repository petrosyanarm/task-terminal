...
function SecondChart() {
  return (
    <div className="bg-black px-6 py-6 shadow-[0_10px_30px_rgba(238,238,238,0.502)] flex flex-col rounded-3xl">
      <div className="flex">
        <h2 className="text-[18px] font-montserrat font-semibold text-blue-gray">Top 10 Trending Locations</h2>
      </div>
