...
function ThirdDonutChart() {
  ...
  return (
    <div className="bg-white px-1 xl:px-0 2xl:px-6.25 py-10 flex flex-col rounded-[28px] shadow-[0_10px_30px_rgba(238,238,238,0.502)]">
      <div className="flex flex-col gap-10">
        ...
        <div className="px-1 grid grid-cols-3 gap-y-3  2xl:grid-cols-4 gap-x-2 2xl:gap-y-5">
